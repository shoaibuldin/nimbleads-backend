...
@Table(schema = "amazon", catalog = "amazon", name = "custom_campaigns_target_bid_caps")
@Entity
@IdClass(value = CustomCampaignAsinTargetBidCapsKey::class)
class CustomCampaignAsinTargetAsinBidCaps {
    @Id
