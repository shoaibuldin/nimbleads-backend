...
import com.nimbleads.model.amazon.CustomCampaignKeywordBidCapsKey
import jakarta.persistence.*
import java.util.*


@Table(schema = "instacart", catalog = "instacart", name = "custom_campaigns_keyword_bid_caps")
@Entity
@IdClass(value = CustomCampaignKeywordBidCapsKey::class)
class InstacartCustomCampaignsKeywordBidCaps {
    @Id
